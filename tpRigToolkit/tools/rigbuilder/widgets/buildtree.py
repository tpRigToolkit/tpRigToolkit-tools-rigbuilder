...
"""
Module that contains widget to show rig builder tree
"""
...
class BuildItem(treewidgets.TreeWidgetItem, object):
    ...
    def __init__(self, parent=None):
        ...
        super(BuildItem, self).__init__(parent)
    ...
    def get_text(self):
        ...
        text_value = super(BuildItem, self).text(0)
...
class BuildTree(treewidgets.FileTreeWidget, object):
    ...
    def __init__(self, settings=None, parent=None):
        super(BuildTree, self).__init__(parent=parent)
    ...
    def resizeEvent(self, event):
        ...
        super(BuildTree, self).resizeEvent(event)
    ...
    def mousePressEvent(self, event):
        ...
        super(BuildTree, self).mousePressEvent(event)
    ...
    def _add_item(self, file_name, state, parent=None, **kwargs):
        ...
        if file_name.count('/') > 0:
            ...
            item = super(BuildTree, self)._add_item(basename, parent=False)
        elif file_name.count('/') == 0:
            item = super(BuildTree, self)._add_item(file_name, parent=parent)
